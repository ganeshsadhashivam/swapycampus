...
const MultiDropdown = () => {
  ...
  const Dropdown = ({
    ...
    <div className="relative my-2 mx-2 w-full sm:w-1/2 md:w-1/3 lg:w-1/6">
      <select
    ...
    // <div className="relative my-2 mx-2 w-30 md:w-60">
    //   <select
    //     className="w-fit px-4 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200"
    //     value={selected || ""}
    //     onChange={(e) => setSelected(e.target.value)}
    //     disabled={disabled}
    //   >
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap justify-center items-center gap-0 p-4">
        <Dropdown
